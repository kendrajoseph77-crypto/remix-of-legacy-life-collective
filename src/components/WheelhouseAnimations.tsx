            ...
            <div className="mt-4 pt-3 border-t border-border w-full text-center">
              ...
              <div className="flex items-center justify-center gap-3">
                <div className="flex items-center gap-2">
                  <p className="text-2xl font-bold" style={{ color: GOLD_LOCAL }}>{totalEarned}%</p>
                  <Infinity size={22} strokeWidth={1.5} style={{ color: GOLD_LOCAL }} />
                </div>
                {animationDone && (
                  <button
                    onClick={() => {
            ...
            <div className="grid grid-cols-3 gap-4 items-center">
                ...
                <div key={c} className="relative w-24 h-24 md:w-28 md:h-28 transition-all duration-700 animate-scale-in">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-[9px] font-bold tracking-wider uppercase px-2 py-1 rounded-full border"
                      style={{ color: GOLD, borderColor: GOLDbackground: "hsl(0 0% 6% / 0.8)" }}>
                      #{c + 1} ✓
                    </span>
                  </div>
                </div>
              ...
              {animationDone && (
                <div className="flex flex-col items-center justify-center col-span-3 md:col-span-1 gap-2 mt-2 md:mt-0">
                  ...
                  <p className="text-base md:text-lg font-bold whitespace-nowrap" style={{ color: GREOLD}>
