...
import { ArrowRight, Users, RefreshCw, Shield, Zap } from "lucide-react";
...
const WheelhouseSVG = ({
  ...
  // positions: [center, top(1), bottom(2), topLeft(3), topRight(4), bottomLeft(5), bottomRight(6)]
  const center = positions[0];
  const slots = [
    { x: 150, y: 52, label: positions[1] },   // 1 top
    { x: 150, y: 248, label: positions[2] },   // 2 bottom
    { x: 52, y: 100, label: positions[3] },    // 3 top-left
    { x: 248, y: 100, label: positions[4] },   // 4 top-right
    { x: 52, y: 200, label: positions[5] },    // 5 bottom-left
    { x: 248, y: 200, label: positions[6] },   // 6 bottom-right
  ];

  return (
    <div className="flex flex-col items-center gap-3">
      <svg viewBox="0 0 300 300" className="w-48 h-48 md:w-56 md:h-56">
        {/* Outer ring */}
        ...
        {slots.map((slot, i) =>
          slot.label ? (
            <text key={i} x={slot.x} y={slot.y} textAnchor="middle" dominantBaseline="middle"
      ...
      <p className="text-sm font-semibold tracking-widest uppercase text-white/70">{label}</p>
    </div>
  );
};
...
const steps = [
  ...
  },
  {
    ...
    desc: "Help your 2 friends each invite 2 friends. Their contributions fill the remaining 4 positions — and you receive from each one.",
    color: GOLD,
  },
];
    ...
    <div className="min-h-screen bg-[hsl(0_0%_6%)] text-white">
      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl leading-relaxed max-w-2xl mx-auto text-white/60">
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex items-center justify-center gap-0 max-w-lg mx-auto">
            <div className="flex-1 p-6 text-center rounded-l-xl" style={{ background: `${BLUE}20`, borderLeft: `3px solid ${BLUE}` }}>
              ...
              <p className="text-white/50 text-sm mt-2">To Teammate 1</p>
            </div>
            ...
            <div className="flex-1 p-6 text-center rounded-r-xl" style={{ background: `${GREEN}20`, borderRight: `3px solid ${GREEN}` }}>
              ...
              <p className="text-white/50 text-sm mt-2">To Teammate 2</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            <div className="p-5 rounded-xl border border-white/10 bg-white/[0.03]">
              ...
              <p className="text-white/50 text-sm leading-relaxed">
                Your 2 friends each invite 2 friends. That completes your Wheelhouse — you've received 6 contributions.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-white/10 bg-white/[0.03]">
      ...
      <section className="py-16 border-t border-white/10">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-white/50 max-w-xl mx-auto">
              Your ultimate goal is to be active on all 3 Income Centers simultaneously.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              >
                <p className="text-xl font-bold mb-3" style={{ color: sys.color, fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
                  {sys.name}
                </p>
      ...
      <section className="py-20 border-t border-white/10">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-white/50 mb-8">
            The system is live and waiting for you. Join thousands who are already receiving.
          </p>
          <Link
            to="/#join"
