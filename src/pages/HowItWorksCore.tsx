...
const HowItWorksCore = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-20 pb-4 relative overflow-hidden">
        <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-3 bg-white">
          ...
          <nav className="flex items-center gap-4">
            ...
            <Link to="/register/core" className="text-sm font-medium underline text-black/70 hover:text-black transition-colors">
              Join Now
            </Link>
      ...
      <section className="pt-14 pb-6 relative overflow-hidden" style={{ background: `linear-gradient(180deg, hsl(160 80% 42% / 0.06) 0%, hsl(160 80% 42% / 0.02) 100%)` }}>
        <div className="absolute inset-0" style={{ background: `radial-gradient(ellipse 60% 50% at 50% 40%, hsl(160 80% 42% / 0.08) 0%, transparent 70%)` }} />
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <div className="text-center mb-14">
            <p className="text-sm tracking-[0.3em] uppercase font-medium mb-3" style={{ color: GREEN }}>World Famous Mobius Loop</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">When One Completes, Another One Opens</h2>
            <div className="w-16 h-[1px] mx-auto" style={{ background: `linear-gradient(90deg, transparent, ${GREEN}, transparent)` }} />
          </div>
          <div className="mb-14">
