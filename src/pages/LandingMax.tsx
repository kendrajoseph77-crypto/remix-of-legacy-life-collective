        ...
        <div className="relative z-10 w-full flex flex-col items-center flex-1 pt-4 pb-2 px-6">
          ...
          <div className="absolute top-4 left-6 z-20">
            <img
              ...
              alt="5050 Max logo"
              className="w-auto"
              style={{ height: "72px", filter: "drop-shadow(0 0 16px hsl(39 55% 52% / 0.4))" }}
            />
          </div>
      ...
      <section id="join" className="bg-background py-16 px-6">
        <div className="max-w-md mx-auto">
          <div className="flex flex-col items-center mb-12">
            ...
            <p className="text-muted-foreground mt-2 text-center">Maximum impact. Maximum returns.</p>
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              <div className="relative mb-3">
                <img src={logoM} alt="5050 Max logo" className="absolute left-0 top-1/2 -translate-y-1/2 w-auto" style={{ height: "48px" }} />
                <h3 className="text-xl font-bold text-center" style={{ color: GOLD }}>5050 Max</h3>
              </div>
              <div className="grid grid-cols-3 gap-1.5 mb-4">
                {vaults.map((v, vi) => (
                  <div key={vi} className="p-1.5 rounded-lg border border-border bg-muted/20 flex flex-col items-center justify-center">
                    <p className="text-xs font-semibold truncate w-full text-center" style={{ color: GOLD }}>{v.contribution}</p>
              ...
              <p className="text-center">
                ...
                <span className="text-xl font-bold" style={{ color: GOLD }}>$52,500</span>
                <span className="text-xs font-normal text-muted-foreground ml-1">Each Cycle</span>
              </p>
            </div>
            <Link
              to="/register/max"
              className="block w-full py-4 rounded-md font-bold tracking-widest text-xs text-center transition-all duration-300 hover:brightness-110"
              style={{
                background: "linear-gradient(135deg, hsl(41 50% 65%), hsl(39 55% 52%), hsl(35 55% 40%))",
                boxShadow: "0 4px 16px hsl(39 55% 52% / 0.4), inset 0 1px 0 hsl(42 45% 75% / 0.5)",
                color: "hsl(35 30% 10%)",
              }}
            >
              ACTIVATE MAX
